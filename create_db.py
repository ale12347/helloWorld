...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name': 'Smith', 'major_id': 3,
         'birth_date': dt.datetime(2007, 6, 1),'email': 'student1@email.com', 'is_honors': 1},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'major_id': 6,
         'birth_date': dt.datetime(2008, 3, 24), 'email': 'student2@email.com', 'is_honors': 0},
    ]
    ...
    for each_student in students:
        ...
        a_student = Student(first_name=each_student["first_name"], last_name=each_student["last_name"],
                            major_id=each_student["major_id"], birth_date=each_student["birth_date"], email=each_student["email"],
